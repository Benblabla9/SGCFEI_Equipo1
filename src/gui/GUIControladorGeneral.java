...
public class GUIControladorGeneral implements Initializable {
    ...
    public static void limiteTextField(TextField textField, int limit) {
    ...
    public static void palabrasProhibidasTextField(TextField textField) {
    ...
    public static void numerosProhibidosTextField(TextField textField) {
        textField.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue,
                                String newValue) {
    ...
    public static void espaciosProhibidosTextField(TextField textField) {
        textField.textProperty().addListener(new ChangeListener<String>() {
            @Override
            public void changed(ObservableValue<? extends String> observable, String oldValue,
                                String newValue) {
